...
class queens:
    ...
    def hill_solution(self):
        while 1:
            ...
            if self.verbocity == True:
                print
                "Board Violations", self.calc_cost(self.mboard)
                print
                self.mboard
        if self.cost != 0:
            if self.verbocity == True:
    ...
    def printstats(self):
        ...
        print
        "Total Success: ", self.totalsucc
        print
        "Success Percentage: ", float(self.totalsucc) / float(self.totalruns)
        print
        "Average number of steps: ", float(self.totalnumsteps) / float(self.totalruns)
