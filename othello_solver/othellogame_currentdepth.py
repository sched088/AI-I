...
class MinimaxPlayer:
    ...
    def maxi_move(self, state):
        ...
        if self.current_depth > self.depth:
            print("1")
            return self.current_depth, state
        for tmove in legals:
            self.current_depth, state2 = self.mini_move(self.current_depth, result(state, tmove))
            print("Current State: " + str(state.current))
            print("State2: " + str(state2))

            if state2.utility > best_move:
                state, move = state2, tmove
        print("2")
        return self.current_depth, state.utility, self.move
    ...
    def mini_move(self, state):
        ...
        if self.current_depth > self.depth:
            ...
            return self.current_depth, state
        for tmove in legals:
            self.current_depth, state2 = self.maxi_move(self.current_depth, result(state, tmove))
            print("State2: " + str(state2))

            if state2.utility < best_move:
                state, move = state2, tmove
        print("4")
        return self.current_depth, state, self.move
    ...
    def make_move(self, state):
        ...
        while curr_move is None:
            ...
            while self.current_depth < self.depth:
                print("Here!")
                state, move = self.maxi_move(self.current_depth, state)
                print(move)
            print("Here!!")
            # if self.color == 1:
            #     print("White ", end='')
...
def result(state, action):
    ...
    if flipped:
        ...
        print("newstate Utility: " + str(newstate.utility))
        return newstate
    else:
...
def play_game(p1=RandomPlayer(BLACK), p2=MinimaxPlayer(WHITE, 4)):
